// src/modules/seatavailability/Application/UseCases/ReleaseSeatUseCase.cs
...
public sealed class ReleaseSeatUseCase
{
    ...
    public ReleaseSeatUseCase(ISeatAvailabilityRepository repository) => _repository = repository;
