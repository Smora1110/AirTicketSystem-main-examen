// src/modules/seatavailability/Application/UseCases/ReserveSeatUseCase.cs
...
public sealed class ReserveSeatUseCase
{
    private readonly ISeatAvailabilityRepository _repository;

    public ReserveSeatUseCase(ISeatAvailabilityRepository repository) => _repository = repository;
