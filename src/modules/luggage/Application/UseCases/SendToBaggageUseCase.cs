// src/modules/luggage/Application/UseCases/SendToBaggageUseCase.cs
...
public sealed class SendToBaggageUseCase
{
    private readonly ILuggageRepository _repository;

    public SendToBaggageUseCase(ILuggageRepository repository) => _repository = repository;
