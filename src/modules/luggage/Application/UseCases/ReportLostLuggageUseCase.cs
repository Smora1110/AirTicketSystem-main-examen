// src/modules/luggage/Application/UseCases/ReportLostLuggageUseCase.cs
...
public sealed class ReportLostLuggageUseCase
{
    private readonly ILuggageRepository _repository;

    public ReportLostLuggageUseCase(ILuggageRepository repository) => _repository = repository;
